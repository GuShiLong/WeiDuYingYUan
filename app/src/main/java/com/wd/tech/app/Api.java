...
public interface Api {
    ...
    @GET
    public Observable<ResponseBody> getHot(@Url String url, @Header("userId") int userid,@Header("sessionId") String sessionid);

    @GET
    public Observable<ResponseBody> getHotshowing(@Url String url, @Header("userId") int userid,@Header("sessionId") String sessionid);

    @GET
    public Observable<ResponseBody> getShangYing(@Url String url, @Header("userId") int userid,@Header("sessionId") String sessionid);
